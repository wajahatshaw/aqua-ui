...
export default class IssuesComponent extends Component{
    render(){
        return (<View style={{backgroundColor: LIGHT_BLUE, paddingVertical: 10, paddingHorizontal: 15, marginTop: 15}}>
